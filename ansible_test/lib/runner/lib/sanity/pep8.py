...
PEP8_SKIP_PATH = os.path.join(
    os.path.dirname(ansible_test.__file__),
    'lib/sanity/pep8/skip.txt'
)
#PEP8_LEGACY_PATH = 'test/sanity/pep8/legacy-files.txt'
PEP8_LEGACY_PATH = os.path.join(
    os.path.dirname(ansible_test.__file__),
    'lib/sanity/pep8/legacy-files.txt'
)
...
class Pep8Test(SanitySingleVersion):
    ...
    def test(self, args, targets):
        ...
        legacy_ignore_file = os.path.join(
            os.path.dirname(ansible_test.__file__),
            'lib/sanity/pep8/legacy-ignore.txt'
        )
        ...
        current_ignore_file = os.path.join(
            os.path.dirname(ansible_test.__file__),
            'lib/sanity/pep8/current-ignore.txt'
        )
